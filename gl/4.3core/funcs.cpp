...
void gl4_3core_glUniformBlockBinding(void *_glfuncs, GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding)
{
	QOpenGLFunctions_4_3_Core* _qglfuncs = reinterpret_cast<QOpenGLFunctions_4_3_Core*>(_glfuncs);
...
void gl4_3core_glUniformSubroutinesuiv(void *_glfuncs, GLenum shadertype, GLsizei count, const GLuint* indices)
{
	QOpenGLFunctions_4_3_Core* _qglfuncs = reinterpret_cast<QOpenGLFunctions_4_3_Core*>(_glfuncs);
...
void gl4_3core_glUniform4d(void *_glfuncs, GLint location, GLdouble x, GLdouble y, GLdouble z, GLdouble w)
{
	QOpenGLFunctions_4_3_Core* _qglfuncs = reinterpret_cast<QOpenGLFunctions_4_3_Core*>(_glfuncs);
	_qglfuncs->glUniform4d(location, x, y, z, w);
}

void gl4_3core_glUniform3d(void *_glfuncs, GLint location, GLdouble x, GLdouble y, GLdouble z)
{
	QOpenGLFunctions_4_3_Core* _qglfuncs = reinterpret_cast<QOpenGLFunctions_4_3_Core*>(_glfuncs);
	_qglfuncs->glUniform3d(location, x, y, z);
}

void gl4_3core_glUniform2d(void *_glfuncs, GLint location, GLdouble x, GLdouble y)
{
	QOpenGLFunctions_4_3_Core* _qglfuncs = reinterpret_cast<QOpenGLFunctions_4_3_Core*>(_glfuncs);
	_qglfuncs->glUniform2d(location, x, y);
}

void gl4_3core_glUniform1d(void *_glfuncs, GLint location, GLdouble x)
{
	QOpenGLFunctions_4_3_Core* _qglfuncs = reinterpret_cast<QOpenGLFunctions_4_3_Core*>(_glfuncs);

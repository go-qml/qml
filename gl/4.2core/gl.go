...
func (gl *GL) IsEnabled(cap glbase.Enum) glbase.Boolean {
	result := C.gl4_2core_glIsEnabled(gl.funcs, C.GLenum(cap))
...
func (gl *GL) GetTexImage(target glbase.Enum, level int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl4_2core_glGetTexImage(gl.funcs, C.GLenum(target), C.GLint(level), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) GetError() glbase.Enum {
	result := C.gl4_2core_glGetError(gl.funcs)
...
func (gl *GL) ReadPixels(x, y, width, height int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl4_2core_glReadPixels(gl.funcs, C.GLint(x), C.GLint(y), C.GLsizei(width), C.GLsizei(height), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) DepthMask(flag glbase.Boolean) {
	C.gl4_2core_glDepthMask(gl.funcs, C.GLboolean(flag))
}

// https://www.opengl.org/sdk/docs/man2/xhtml/glColorMask.xml
func (gl *GL) ColorMask(red, green, blue, alpha glbase.Boolean) {
	C.gl4_2core_glColorMask(gl.funcs, C.GLboolean(red), C.GLboolean(green), C.GLboolean(blue), C.GLboolean(alpha))
}
...
func (gl *GL) TexImage2D(target glbase.Enum, level, internalformat, width, height, border int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl4_2core_glTexImage2D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLint(border), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) TexImage1D(target glbase.Enum, level, internalformat, width, border int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl4_2core_glTexImage1D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(internalformat), C.GLsizei(width), C.GLint(border), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) IsTexture(texture glbase.Texture) glbase.Boolean {
	result := C.gl4_2core_glIsTexture(gl.funcs, C.GLuint(texture))
	return glbase.Boolean(result)
}
...
func (gl *GL) TexSubImage2D(target glbase.Enum, level, xoffset, yoffset, width, height int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl4_2core_glTexSubImage2D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLint(yoffset), C.GLsizei(width), C.GLsizei(height), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) TexSubImage1D(target glbase.Enum, level, xoffset, width int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl4_2core_glTexSubImage1D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLsizei(width), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) DrawElements(mode glbase.Enum, count int32, gltype glbase.Enum, indices interface{}) {
	...
	C.gl4_2core_glDrawElements(gl.funcs, C.GLenum(mode), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) TexSubImage3D(target glbase.Enum, level, xoffset, yoffset, zoffset, width, height, depth int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl4_2core_glTexSubImage3D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLint(yoffset), C.GLint(zoffset), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) TexImage3D(target glbase.Enum, level, internalformat, width, height, depth, border int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl4_2core_glTexImage3D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLint(border), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) DrawRangeElements(mode glbase.Enum, start, end uint32, count int32, gltype glbase.Enum, indices interface{}) {
	...
	C.gl4_2core_glDrawRangeElements(gl.funcs, C.GLenum(mode), C.GLuint(start), C.GLuint(end), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) GetCompressedTexImage(target glbase.Enum, level int32, img interface{}) {
	...
	C.gl4_2core_glGetCompressedTexImage(gl.funcs, C.GLenum(target), C.GLint(level), unsafe.Pointer(img_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) CompressedTexSubImage1D(target glbase.Enum, level, xoffset, width int32, format glbase.Enum, imageSize int32, data interface{}) {
	...
	C.gl4_2core_glCompressedTexSubImage1D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLsizei(width), C.GLenum(format), C.GLsizei(imageSize), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) CompressedTexSubImage2D(target glbase.Enum, level, xoffset, yoffset, width, height int32, format glbase.Enum, imageSize int32, data interface{}) {
	...
	C.gl4_2core_glCompressedTexSubImage2D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLint(yoffset), C.GLsizei(width), C.GLsizei(height), C.GLenum(format), C.GLsizei(imageSize), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) CompressedTexSubImage3D(target glbase.Enum, level, xoffset, yoffset, zoffset, width, height, depth int32, format glbase.Enum, imageSize int32, data interface{}) {
	...
	C.gl4_2core_glCompressedTexSubImage3D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLint(yoffset), C.GLint(zoffset), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLenum(format), C.GLsizei(imageSize), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) CompressedTexImage1D(target glbase.Enum, level int32, internalformat glbase.Enum, width, border, imageSize int32, data interface{}) {
	...
	C.gl4_2core_glCompressedTexImage1D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLenum(internalformat), C.GLsizei(width), C.GLint(border), C.GLsizei(imageSize), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) CompressedTexImage2D(target glbase.Enum, level int32, internalformat glbase.Enum, width, height, border, imageSize int32, data interface{}) {
	...
	C.gl4_2core_glCompressedTexImage2D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLenum(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLint(border), C.GLsizei(imageSize), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) CompressedTexImage3D(target glbase.Enum, level int32, internalformat glbase.Enum, width, height, depth, border, imageSize int32, data interface{}) {
	...
	C.gl4_2core_glCompressedTexImage3D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLenum(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLint(border), C.GLsizei(imageSize), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) SampleCoverage(value float32, invert glbase.Boolean) {
	C.gl4_2core_glSampleCoverage(gl.funcs, C.GLfloat(value), C.GLboolean(invert))
}
...
func (gl *GL) UnmapBuffer(target glbase.Enum) glbase.Boolean {
	result := C.gl4_2core_glUnmapBuffer(gl.funcs, C.GLenum(target))
	return glbase.Boolean(result)
}
...
func (gl *GL) GetBufferSubData(target glbase.Enum, offset, size int, data interface{}) {
	...
	C.gl4_2core_glGetBufferSubData(gl.funcs, C.GLenum(target), C.GLintptr(offset), C.GLsizeiptr(size), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) BufferSubData(target glbase.Enum, offset, size int, data interface{}) {
	...
	C.gl4_2core_glBufferSubData(gl.funcs, C.GLenum(target), C.GLintptr(offset), C.GLsizeiptr(size), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) BufferData(target glbase.Enum, size int, data interface{}, usage glbase.Enum) {
	...
	C.gl4_2core_glBufferData(gl.funcs, C.GLenum(target), C.GLsizeiptr(size), unsafe.Pointer(data_v.Index(0).Addr().Pointer()), C.GLenum(usage))
}

// https://www.opengl.org/sdk/docs/man2/xhtml/glIsBuffer.xml
func (gl *GL) IsBuffer(buffer glbase.Buffer) glbase.Boolean {
	result := C.gl4_2core_glIsBuffer(gl.funcs, C.GLuint(buffer))
	return glbase.Boolean(result)
}
...
func (gl *GL) IsQuery(id uint32) glbase.Boolean {
	result := C.gl4_2core_glIsQuery(gl.funcs, C.GLuint(id))
	return glbase.Boolean(result)
}
...
func (gl *GL) VertexAttribPointer(index uint32, size int32, gltype glbase.Enum, normalized glbase.Boolean, stride int32, pointer interface{}) {
	...
	C.gl4_2core_glVertexAttribPointer(gl.funcs, C.GLuint(index), C.GLint(size), C.GLenum(gltype), C.GLboolean(normalized), C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) UniformMatrix4fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glUniformMatrix4fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix3fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glUniformMatrix3fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix2fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glUniformMatrix2fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ShaderSource(shader glbase.Shader, source ...string) {
	...
	C.gl4_2core_glShaderSource(gl.funcs, C.GLuint(shader), C.GLsizei(count), (**C.GLchar)(unsafe.Pointer(&glstring[0])), (*C.GLint)(unsafe.Pointer(&length[0])))
}
...
func (gl *GL) GetVertexAttribiv(index uint32, pname glbase.Enum, params []int32) {
	C.gl4_2core_glGetVertexAttribiv(gl.funcs, C.GLuint(index), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetVertexAttribfv(index uint32, pname glbase.Enum, params []float32) {
	C.gl4_2core_glGetVertexAttribfv(gl.funcs, C.GLuint(index), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetVertexAttribdv(index uint32, pname glbase.Enum, params []float64) {
	C.gl4_2core_glGetVertexAttribdv(gl.funcs, C.GLuint(index), C.GLenum(pname), (*C.GLdouble)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetUniformiv(program glbase.Program, location glbase.Uniform, params []int32) {
	C.gl4_2core_glGetUniformiv(gl.funcs, C.GLuint(program), C.GLint(location), (*C.GLint)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetUniformfv(program glbase.Program, location glbase.Uniform, params []float32) {
	C.gl4_2core_glGetUniformfv(gl.funcs, C.GLuint(program), C.GLint(location), (*C.GLfloat)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetUniformLocation(program glbase.Program, name []byte) int32 {
	result := C.gl4_2core_glGetUniformLocation(gl.funcs, C.GLuint(program), (*C.GLchar)(unsafe.Pointer(&name[0])))
	return int32(result)
}
...
func (gl *GL) GetShaderInfoLog(shader glbase.Shader, bufSize int32, length []int32, infoLog []byte) {
	C.gl4_2core_glGetShaderInfoLog(gl.funcs, C.GLuint(shader), C.GLsizei(bufSize), (*C.GLsizei)(unsafe.Pointer(&length[0])), (*C.GLchar)(unsafe.Pointer(&infoLog[0])))
}
...
func (gl *GL) GetShaderiv(shader glbase.Shader, pname glbase.Enum, params []int32) {
	C.gl4_2core_glGetShaderiv(gl.funcs, C.GLuint(shader), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetProgramInfoLog(program glbase.Program, bufSize int32, length []int32, infoLog []byte) {
	C.gl4_2core_glGetProgramInfoLog(gl.funcs, C.GLuint(program), C.GLsizei(bufSize), (*C.GLsizei)(unsafe.Pointer(&length[0])), (*C.GLchar)(unsafe.Pointer(&infoLog[0])))
}
...
func (gl *GL) GetProgramiv(program glbase.Program, pname glbase.Enum, params []int32) {
	C.gl4_2core_glGetProgramiv(gl.funcs, C.GLuint(program), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetAttribLocation(program glbase.Program, name []byte) int32 {
	result := C.gl4_2core_glGetAttribLocation(gl.funcs, C.GLuint(program), (*C.GLchar)(unsafe.Pointer(&name[0])))
	return int32(result)
}
...
func (gl *GL) CreateShader(gltype glbase.Enum) glbase.Shader {
	result := C.gl4_2core_glCreateShader(gl.funcs, C.GLenum(gltype))
...
func (gl *GL) CreateProgram() glbase.Program {
	result := C.gl4_2core_glCreateProgram(gl.funcs)
...
func (gl *GL) BindAttribLocation(program glbase.Program, index uint32, name []byte) {
	C.gl4_2core_glBindAttribLocation(gl.funcs, C.GLuint(program), C.GLuint(index), (*C.GLchar)(unsafe.Pointer(&name[0])))
}
...
func (gl *GL) UniformMatrix4x3fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glUniformMatrix4x3fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix3x4fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glUniformMatrix3x4fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix4x2fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glUniformMatrix4x2fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix2x4fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glUniformMatrix2x4fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix3x2fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glUniformMatrix3x2fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix2x3fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glUniformMatrix2x3fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}

// https://www.opengl.org/sdk/docs/man2/xhtml/glIsVertexArray.xml
func (gl *GL) IsVertexArray(array uint32) glbase.Boolean {
	result := C.gl4_2core_glIsVertexArray(gl.funcs, C.GLuint(array))
	return glbase.Boolean(result)
}
...
func (gl *GL) CheckFramebufferStatus(target glbase.Enum) glbase.Enum {
	result := C.gl4_2core_glCheckFramebufferStatus(gl.funcs, C.GLenum(target))
	return glbase.Enum(result)
}
...
func (gl *GL) IsFramebuffer(framebuffer uint32) glbase.Boolean {
	result := C.gl4_2core_glIsFramebuffer(gl.funcs, C.GLuint(framebuffer))
	return glbase.Boolean(result)
}
...
func (gl *GL) IsRenderbuffer(renderbuffer uint32) glbase.Boolean {
	result := C.gl4_2core_glIsRenderbuffer(gl.funcs, C.GLuint(renderbuffer))
	return glbase.Boolean(result)
}
...
func (gl *GL) GetFragDataLocation(program glbase.Program, name []byte) int32 {
	result := C.gl4_2core_glGetFragDataLocation(gl.funcs, C.GLuint(program), (*C.GLchar)(unsafe.Pointer(&name[0])))
	return int32(result)
}
...
func (gl *GL) VertexAttribIPointer(index uint32, size int32, gltype glbase.Enum, stride int32, pointer interface{}) {
	...
	C.gl4_2core_glVertexAttribIPointer(gl.funcs, C.GLuint(index), C.GLint(size), C.GLenum(gltype), C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) IsEnabledi(target glbase.Enum, index uint32) glbase.Boolean {
	result := C.gl4_2core_glIsEnabledi(gl.funcs, C.GLenum(target), C.GLuint(index))
	return glbase.Boolean(result)
}
...
func (gl *GL) ColorMaski(index uint32, r, g, b, a glbase.Boolean) {
	C.gl4_2core_glColorMaski(gl.funcs, C.GLuint(index), C.GLboolean(r), C.GLboolean(g), C.GLboolean(b), C.GLboolean(a))
}
...
func (gl *GL) UniformBlockBinding(program glbase.Program, uniformBlockIndex, uniformBlockBinding uint32) {
	C.gl4_2core_glUniformBlockBinding(gl.funcs, C.GLuint(program), C.GLuint(uniformBlockIndex), C.GLuint(uniformBlockBinding))
}
...
func (gl *GL) GetUniformBlockIndex(program glbase.Program, uniformBlockName []byte) uint32 {
	result := C.gl4_2core_glGetUniformBlockIndex(gl.funcs, C.GLuint(program), (*C.GLchar)(unsafe.Pointer(&uniformBlockName[0])))
...
func (gl *GL) DrawElementsInstanced(mode glbase.Enum, count int32, gltype glbase.Enum, indices interface{}, instancecount int32) {
	...
	C.gl4_2core_glDrawElementsInstanced(gl.funcs, C.GLenum(mode), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()), C.GLsizei(instancecount))
}
...
func (gl *GL) TexImage3DMultisample(target glbase.Enum, samples, internalformat, width, height, depth int32, fixedsamplelocations glbase.Boolean) {
	C.gl4_2core_glTexImage3DMultisample(gl.funcs, C.GLenum(target), C.GLsizei(samples), C.GLint(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLboolean(fixedsamplelocations))
}
...
func (gl *GL) TexImage2DMultisample(target glbase.Enum, samples, internalformat, width, height int32, fixedsamplelocations glbase.Boolean) {
	C.gl4_2core_glTexImage2DMultisample(gl.funcs, C.GLenum(target), C.GLsizei(samples), C.GLint(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLboolean(fixedsamplelocations))
}
...
func (gl *GL) GetSynciv(sync glbase.Sync, pname glbase.Enum, bufSize int32, length, values []int32) {
	C.gl4_2core_glGetSynciv(gl.funcs, C.GLsync(sync), C.GLenum(pname), C.GLsizei(bufSize), (*C.GLsizei)(unsafe.Pointer(&length[0])), (*C.GLint)(unsafe.Pointer(&values[0])))
}
...
func (gl *GL) WaitSync(sync glbase.Sync, flags glbase.Bitfield, timeout uint64) {
	C.gl4_2core_glWaitSync(gl.funcs, C.GLsync(sync), C.GLbitfield(flags), C.GLuint64(timeout))
}
...
func (gl *GL) FenceSync(condition glbase.Enum, flags glbase.Bitfield) glbase.Sync {
	result := C.gl4_2core_glFenceSync(gl.funcs, C.GLenum(condition), C.GLbitfield(flags))
...
func (gl *GL) DrawElementsInstancedBaseVertex(mode glbase.Enum, count int32, gltype glbase.Enum, indices interface{}, instancecount, basevertex int32) {
	...
	C.gl4_2core_glDrawElementsInstancedBaseVertex(gl.funcs, C.GLenum(mode), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()), C.GLsizei(instancecount), C.GLint(basevertex))
}
...
func (gl *GL) DrawRangeElementsBaseVertex(mode glbase.Enum, start, end uint32, count int32, gltype glbase.Enum, indices interface{}, basevertex int32) {
	...
	C.gl4_2core_glDrawRangeElementsBaseVertex(gl.funcs, C.GLenum(mode), C.GLuint(start), C.GLuint(end), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()), C.GLint(basevertex))
}
...
func (gl *GL) DrawElementsBaseVertex(mode glbase.Enum, count int32, gltype glbase.Enum, indices interface{}, basevertex int32) {
	...
	C.gl4_2core_glDrawElementsBaseVertex(gl.funcs, C.GLenum(mode), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()), C.GLint(basevertex))
}
...
func (gl *GL) VertexAttribP4uiv(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value []uint32) {
	C.gl4_2core_glVertexAttribP4uiv(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), (*C.GLuint)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) VertexAttribP4ui(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value uint32) {
	C.gl4_2core_glVertexAttribP4ui(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), C.GLuint(value))
}
...
func (gl *GL) VertexAttribP3uiv(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value []uint32) {
	C.gl4_2core_glVertexAttribP3uiv(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), (*C.GLuint)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) VertexAttribP3ui(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value uint32) {
	C.gl4_2core_glVertexAttribP3ui(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), C.GLuint(value))
}
...
func (gl *GL) VertexAttribP2uiv(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value []uint32) {
	C.gl4_2core_glVertexAttribP2uiv(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), (*C.GLuint)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) VertexAttribP2ui(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value uint32) {
	C.gl4_2core_glVertexAttribP2ui(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), C.GLuint(value))
}
...
func (gl *GL) VertexAttribP1uiv(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value []uint32) {
	C.gl4_2core_glVertexAttribP1uiv(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), (*C.GLuint)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) VertexAttribP1ui(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value uint32) {
	C.gl4_2core_glVertexAttribP1ui(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), C.GLuint(value))
}
...
func (gl *GL) IsSampler(sampler uint32) glbase.Boolean {
	result := C.gl4_2core_glIsSampler(gl.funcs, C.GLuint(sampler))
	return glbase.Boolean(result)
}
...
func (gl *GL) GetFragDataIndex(program glbase.Program, name []byte) int32 {
	result := C.gl4_2core_glGetFragDataIndex(gl.funcs, C.GLuint(program), (*C.GLchar)(unsafe.Pointer(&name[0])))
	return int32(result)
}
...
func (gl *GL) IsTransformFeedback(id uint32) glbase.Boolean {
	result := C.gl4_2core_glIsTransformFeedback(gl.funcs, C.GLuint(id))
	return glbase.Boolean(result)
}
...
func (gl *GL) UniformSubroutinesuiv(shadertype glbase.Enum, count int32, indices []uint32) {
	C.gl4_2core_glUniformSubroutinesuiv(gl.funcs, C.GLenum(shadertype), C.GLsizei(count), (*C.GLuint)(unsafe.Pointer(&indices[0])))
}
...
func (gl *GL) GetSubroutineIndex(program glbase.Program, shadertype glbase.Enum, name []byte) uint32 {
	result := C.gl4_2core_glGetSubroutineIndex(gl.funcs, C.GLuint(program), C.GLenum(shadertype), (*C.GLchar)(unsafe.Pointer(&name[0])))
	return uint32(result)
}
...
func (gl *GL) GetSubroutineUniformLocation(program glbase.Program, shadertype glbase.Enum, name []byte) int32 {
	result := C.gl4_2core_glGetSubroutineUniformLocation(gl.funcs, C.GLuint(program), C.GLenum(shadertype), (*C.GLchar)(unsafe.Pointer(&name[0])))
	return int32(result)
}
...
func (gl *GL) UniformMatrix4x3dv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glUniformMatrix4x3dv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix4x2dv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glUniformMatrix4x2dv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix3x4dv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glUniformMatrix3x4dv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix3x2dv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glUniformMatrix3x2dv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix2x4dv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glUniformMatrix2x4dv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix2x3dv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glUniformMatrix2x3dv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix4dv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glUniformMatrix4dv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix3dv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glUniformMatrix3dv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix2dv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glUniformMatrix2dv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) DrawElementsIndirect(mode, gltype glbase.Enum, indirect interface{}) {
	...
	C.gl4_2core_glDrawElementsIndirect(gl.funcs, C.GLenum(mode), C.GLenum(gltype), unsafe.Pointer(indirect_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) DrawArraysIndirect(mode glbase.Enum, indirect interface{}) {
	...
	C.gl4_2core_glDrawArraysIndirect(gl.funcs, C.GLenum(mode), unsafe.Pointer(indirect_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) VertexAttribLPointer(index uint32, size int32, gltype glbase.Enum, stride int32, pointer interface{}) {
	...
	C.gl4_2core_glVertexAttribLPointer(gl.funcs, C.GLuint(index), C.GLint(size), C.GLenum(gltype), C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) ProgramUniformMatrix4x3dv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glProgramUniformMatrix4x3dv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix3x4dv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glProgramUniformMatrix3x4dv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix4x2dv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glProgramUniformMatrix4x2dv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix2x4dv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glProgramUniformMatrix2x4dv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix3x2dv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glProgramUniformMatrix3x2dv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix2x3dv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glProgramUniformMatrix2x3dv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix4x3fv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glProgramUniformMatrix4x3fv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix3x4fv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glProgramUniformMatrix3x4fv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix4x2fv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glProgramUniformMatrix4x2fv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix2x4fv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glProgramUniformMatrix2x4fv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix3x2fv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glProgramUniformMatrix3x2fv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix2x3fv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glProgramUniformMatrix2x3fv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix4dv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glProgramUniformMatrix4dv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix3dv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glProgramUniformMatrix3dv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix2dv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float64) {
	...
	C.gl4_2core_glProgramUniformMatrix2dv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLdouble)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix4fv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glProgramUniformMatrix4fv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix3fv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glProgramUniformMatrix3fv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ProgramUniformMatrix2fv(program glbase.Program, location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl4_2core_glProgramUniformMatrix2fv(gl.funcs, C.GLuint(program), C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) IsProgramPipeline(pipeline uint32) glbase.Boolean {
	result := C.gl4_2core_glIsProgramPipeline(gl.funcs, C.GLuint(pipeline))
	return glbase.Boolean(result)
}
...
func (gl *GL) ProgramBinary(program glbase.Program, binaryFormat glbase.Enum, binary interface{}, length int32) {
	...
	C.gl4_2core_glProgramBinary(gl.funcs, C.GLuint(program), C.GLenum(binaryFormat), unsafe.Pointer(binary_v.Index(0).Addr().Pointer()), C.GLsizei(length))
}
...
func (gl *GL) GetProgramBinary(program glbase.Program, bufSize int32, length []int32, binaryFormat []glbase.Enum, binary interface{}) {
	...
	C.gl4_2core_glGetProgramBinary(gl.funcs, C.GLuint(program), C.GLsizei(bufSize), (*C.GLsizei)(unsafe.Pointer(&length[0])), (*C.GLenum)(unsafe.Pointer(&binaryFormat[0])), unsafe.Pointer(binary_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) ShaderBinary(count int32, shaders []uint32, binaryformat glbase.Enum, binary interface{}, length int32) {
	...
	C.gl4_2core_glShaderBinary(gl.funcs, C.GLsizei(count), (*C.GLuint)(unsafe.Pointer(&shaders[0])), C.GLenum(binaryformat), unsafe.Pointer(binary_v.Index(0).Addr().Pointer()), C.GLsizei(length))
}
...
func (gl *GL) BindImageTexture(unit uint32, texture glbase.Texture, level int32, layered glbase.Boolean, layer int32, access, format glbase.Enum) {
	C.gl4_2core_glBindImageTexture(gl.funcs, C.GLuint(unit), C.GLuint(texture), C.GLint(level), C.GLboolean(layered), C.GLint(layer), C.GLenum(access), C.GLenum(format))
}
...
func (gl *GL) DrawElementsInstancedBaseVertexBaseInstance(mode glbase.Enum, count int32, gltype glbase.Enum, indices interface{}, instancecount, basevertex int32, baseinstance uint32) {
	...
	C.gl4_2core_glDrawElementsInstancedBaseVertexBaseInstance(gl.funcs, C.GLenum(mode), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()), C.GLsizei(instancecount), C.GLint(basevertex), C.GLuint(baseinstance))
}
...
func (gl *GL) DrawElementsInstancedBaseInstance(mode glbase.Enum, count int32, gltype glbase.Enum, indices interface{}, instancecount int32, baseinstance uint32) {
	...
	C.gl4_2core_glDrawElementsInstancedBaseInstance(gl.funcs, C.GLenum(mode), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()), C.GLsizei(instancecount), C.GLuint(baseinstance))
}

...
void gl2_1_glVertexAttribPointer(void *_glfuncs, GLuint index, GLint size, GLenum gltype, GLboolean normalized, GLsizei stride, const GLvoid* pointer)
{
	QOpenGLFunctions_2_1* _qglfuncs = reinterpret_cast<QOpenGLFunctions_2_1*>(_glfuncs);
...
void gl2_1_glShaderSource(void *_glfuncs, GLuint shader, GLsizei count, const GLchar** glstring, const GLint* length)
{
	QOpenGLFunctions_2_1* _qglfuncs = reinterpret_cast<QOpenGLFunctions_2_1*>(_glfuncs);

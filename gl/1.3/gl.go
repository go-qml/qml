...
func (gl *GL) IsEnabled(cap glbase.Enum) glbase.Boolean {
	result := C.gl1_3_glIsEnabled(gl.funcs, C.GLenum(cap))
...
func (gl *GL) GetError() glbase.Enum {
	result := C.gl1_3_glGetError(gl.funcs)
...
func (gl *GL) DepthMask(flag glbase.Boolean) {
	C.gl1_3_glDepthMask(gl.funcs, C.GLboolean(flag))
}

// https://www.opengl.org/sdk/docs/man2/xhtml/glColorMask.xml
func (gl *GL) ColorMask(red, green, blue, alpha glbase.Boolean) {
	C.gl1_3_glColorMask(gl.funcs, C.GLboolean(red), C.GLboolean(green), C.GLboolean(blue), C.GLboolean(alpha))
}
...
func (gl *GL) IsTexture(texture glbase.Texture) glbase.Boolean {
	result := C.gl1_3_glIsTexture(gl.funcs, C.GLuint(texture))
	return glbase.Boolean(result)
}
...
func (gl *GL) SampleCoverage(value float32, invert glbase.Boolean) {
	C.gl1_3_glSampleCoverage(gl.funcs, C.GLfloat(value), C.GLboolean(invert))
}
...
func (gl *GL) IsList(list uint32) glbase.Boolean {
	result := C.gl1_3_glIsList(gl.funcs, C.GLuint(list))
	return glbase.Boolean(result)
}
...
func (gl *GL) RenderMode(mode glbase.Enum) int32 {
	result := C.gl1_3_glRenderMode(gl.funcs, C.GLenum(mode))
	return int32(result)
}
...
func (gl *GL) EdgeFlag(flag glbase.Boolean) {
	C.gl1_3_glEdgeFlag(gl.funcs, C.GLboolean(flag))
}
...
func (gl *GL) GenLists(range_ int32) uint32 {
	result := C.gl1_3_glGenLists(gl.funcs, C.GLsizei(range_))
...
func (gl *GL) AreTexturesResident(n int32, textures []uint32, residences []glbase.Boolean) glbase.Boolean {
	result := C.gl1_3_glAreTexturesResident(gl.funcs, C.GLsizei(n), (*C.GLuint)(unsafe.Pointer(&textures[0])), (*C.GLboolean)(unsafe.Pointer(&residences[0])))
	return glbase.Boolean(result)
}
...
func (gl *GL) Minmax(target, internalformat glbase.Enum, sink glbase.Boolean) {
	C.gl1_3_glMinmax(gl.funcs, C.GLenum(target), C.GLenum(internalformat), C.GLboolean(sink))
}
...
func (gl *GL) Histogram(target glbase.Enum, width int32, internalformat glbase.Enum, sink glbase.Boolean) {
	C.gl1_3_glHistogram(gl.funcs, C.GLenum(target), C.GLsizei(width), C.GLenum(internalformat), C.GLboolean(sink))
}
...
func (gl *GL) GetMinmax(target glbase.Enum, reset glbase.Boolean, format, gltype glbase.Enum, values interface{}) {
	...
	C.gl1_3_glGetMinmax(gl.funcs, C.GLenum(target), C.GLboolean(reset), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(values_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) GetHistogram(target glbase.Enum, reset glbase.Boolean, format, gltype glbase.Enum, values interface{}) {
	...
	C.gl1_3_glGetHistogram(gl.funcs, C.GLenum(target), C.GLboolean(reset), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(values_v.Index(0).Addr().Pointer()))
}

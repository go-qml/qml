...
func (gl *GL) IsEnabled(cap glbase.Enum) glbase.Boolean {
	result := C.gl3_3compat_glIsEnabled(gl.funcs, C.GLenum(cap))
...
func (gl *GL) GetTexImage(target glbase.Enum, level int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl3_3compat_glGetTexImage(gl.funcs, C.GLenum(target), C.GLint(level), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) GetError() glbase.Enum {
	result := C.gl3_3compat_glGetError(gl.funcs)
...
func (gl *GL) ReadPixels(x, y, width, height int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl3_3compat_glReadPixels(gl.funcs, C.GLint(x), C.GLint(y), C.GLsizei(width), C.GLsizei(height), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) DepthMask(flag glbase.Boolean) {
	C.gl3_3compat_glDepthMask(gl.funcs, C.GLboolean(flag))
}

// https://www.opengl.org/sdk/docs/man2/xhtml/glColorMask.xml
func (gl *GL) ColorMask(red, green, blue, alpha glbase.Boolean) {
	C.gl3_3compat_glColorMask(gl.funcs, C.GLboolean(red), C.GLboolean(green), C.GLboolean(blue), C.GLboolean(alpha))
}
...
func (gl *GL) TexImage2D(target glbase.Enum, level, internalformat, width, height, border int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl3_3compat_glTexImage2D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLint(border), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) TexImage1D(target glbase.Enum, level, internalformat, width, border int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl3_3compat_glTexImage1D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(internalformat), C.GLsizei(width), C.GLint(border), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) IsTexture(texture glbase.Texture) glbase.Boolean {
	result := C.gl3_3compat_glIsTexture(gl.funcs, C.GLuint(texture))
	return glbase.Boolean(result)
}
...
func (gl *GL) TexSubImage2D(target glbase.Enum, level, xoffset, yoffset, width, height int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl3_3compat_glTexSubImage2D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLint(yoffset), C.GLsizei(width), C.GLsizei(height), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) TexSubImage1D(target glbase.Enum, level, xoffset, width int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl3_3compat_glTexSubImage1D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLsizei(width), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) DrawElements(mode glbase.Enum, count int32, gltype glbase.Enum, indices interface{}) {
	...
	C.gl3_3compat_glDrawElements(gl.funcs, C.GLenum(mode), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) TexSubImage3D(target glbase.Enum, level, xoffset, yoffset, zoffset, width, height, depth int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl3_3compat_glTexSubImage3D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLint(yoffset), C.GLint(zoffset), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) TexImage3D(target glbase.Enum, level, internalformat, width, height, depth, border int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl3_3compat_glTexImage3D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLint(border), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) DrawRangeElements(mode glbase.Enum, start, end uint32, count int32, gltype glbase.Enum, indices interface{}) {
	...
	C.gl3_3compat_glDrawRangeElements(gl.funcs, C.GLenum(mode), C.GLuint(start), C.GLuint(end), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) GetCompressedTexImage(target glbase.Enum, level int32, img interface{}) {
	...
	C.gl3_3compat_glGetCompressedTexImage(gl.funcs, C.GLenum(target), C.GLint(level), unsafe.Pointer(img_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) CompressedTexSubImage1D(target glbase.Enum, level, xoffset, width int32, format glbase.Enum, imageSize int32, data interface{}) {
	...
	C.gl3_3compat_glCompressedTexSubImage1D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLsizei(width), C.GLenum(format), C.GLsizei(imageSize), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) CompressedTexSubImage2D(target glbase.Enum, level, xoffset, yoffset, width, height int32, format glbase.Enum, imageSize int32, data interface{}) {
	...
	C.gl3_3compat_glCompressedTexSubImage2D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLint(yoffset), C.GLsizei(width), C.GLsizei(height), C.GLenum(format), C.GLsizei(imageSize), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) CompressedTexSubImage3D(target glbase.Enum, level, xoffset, yoffset, zoffset, width, height, depth int32, format glbase.Enum, imageSize int32, data interface{}) {
	...
	C.gl3_3compat_glCompressedTexSubImage3D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLint(xoffset), C.GLint(yoffset), C.GLint(zoffset), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLenum(format), C.GLsizei(imageSize), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) CompressedTexImage1D(target glbase.Enum, level int32, internalformat glbase.Enum, width, border, imageSize int32, data interface{}) {
	...
	C.gl3_3compat_glCompressedTexImage1D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLenum(internalformat), C.GLsizei(width), C.GLint(border), C.GLsizei(imageSize), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) CompressedTexImage2D(target glbase.Enum, level int32, internalformat glbase.Enum, width, height, border, imageSize int32, data interface{}) {
	...
	C.gl3_3compat_glCompressedTexImage2D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLenum(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLint(border), C.GLsizei(imageSize), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) CompressedTexImage3D(target glbase.Enum, level int32, internalformat glbase.Enum, width, height, depth, border, imageSize int32, data interface{}) {
	...
	C.gl3_3compat_glCompressedTexImage3D(gl.funcs, C.GLenum(target), C.GLint(level), C.GLenum(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLint(border), C.GLsizei(imageSize), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) SampleCoverage(value float32, invert glbase.Boolean) {
	C.gl3_3compat_glSampleCoverage(gl.funcs, C.GLfloat(value), C.GLboolean(invert))
}
...
func (gl *GL) UnmapBuffer(target glbase.Enum) glbase.Boolean {
	result := C.gl3_3compat_glUnmapBuffer(gl.funcs, C.GLenum(target))
	return glbase.Boolean(result)
}
...
func (gl *GL) GetBufferSubData(target glbase.Enum, offset, size int, data interface{}) {
	...
	C.gl3_3compat_glGetBufferSubData(gl.funcs, C.GLenum(target), C.GLintptr(offset), C.GLsizeiptr(size), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) BufferSubData(target glbase.Enum, offset, size int, data interface{}) {
	...
	C.gl3_3compat_glBufferSubData(gl.funcs, C.GLenum(target), C.GLintptr(offset), C.GLsizeiptr(size), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) BufferData(target glbase.Enum, size int, data interface{}, usage glbase.Enum) {
	...
	C.gl3_3compat_glBufferData(gl.funcs, C.GLenum(target), C.GLsizeiptr(size), unsafe.Pointer(data_v.Index(0).Addr().Pointer()), C.GLenum(usage))
}

// https://www.opengl.org/sdk/docs/man2/xhtml/glIsBuffer.xml
func (gl *GL) IsBuffer(buffer glbase.Buffer) glbase.Boolean {
	result := C.gl3_3compat_glIsBuffer(gl.funcs, C.GLuint(buffer))
	return glbase.Boolean(result)
}
...
func (gl *GL) IsQuery(id uint32) glbase.Boolean {
	result := C.gl3_3compat_glIsQuery(gl.funcs, C.GLuint(id))
	return glbase.Boolean(result)
}
...
func (gl *GL) VertexAttribPointer(index uint32, size int32, gltype glbase.Enum, normalized glbase.Boolean, stride int32, pointer interface{}) {
	...
	C.gl3_3compat_glVertexAttribPointer(gl.funcs, C.GLuint(index), C.GLint(size), C.GLenum(gltype), C.GLboolean(normalized), C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) UniformMatrix4fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl3_3compat_glUniformMatrix4fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix3fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl3_3compat_glUniformMatrix3fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix2fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl3_3compat_glUniformMatrix2fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) ShaderSource(shader glbase.Shader, source ...string) {
	...
	C.gl3_3compat_glShaderSource(gl.funcs, C.GLuint(shader), C.GLsizei(count), (**C.GLchar)(unsafe.Pointer(&glstring[0])), (*C.GLint)(unsafe.Pointer(&length[0])))
}
...
func (gl *GL) IsShader(shader glbase.Shader) glbase.Boolean {
	result := C.gl3_3compat_glIsShader(gl.funcs, C.GLuint(shader))
	return glbase.Boolean(result)
}

// https://www.opengl.org/sdk/docs/man2/xhtml/glIsProgram.xml
func (gl *GL) IsProgram(program glbase.Program) glbase.Boolean {
	result := C.gl3_3compat_glIsProgram(gl.funcs, C.GLuint(program))
	return glbase.Boolean(result)
}
...
func (gl *GL) GetVertexAttribiv(index uint32, pname glbase.Enum, params []int32) {
	C.gl3_3compat_glGetVertexAttribiv(gl.funcs, C.GLuint(index), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetVertexAttribfv(index uint32, pname glbase.Enum, params []float32) {
	C.gl3_3compat_glGetVertexAttribfv(gl.funcs, C.GLuint(index), C.GLenum(pname), (*C.GLfloat)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetVertexAttribdv(index uint32, pname glbase.Enum, params []float64) {
	C.gl3_3compat_glGetVertexAttribdv(gl.funcs, C.GLuint(index), C.GLenum(pname), (*C.GLdouble)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetUniformiv(program glbase.Program, location glbase.Uniform, params []int32) {
	C.gl3_3compat_glGetUniformiv(gl.funcs, C.GLuint(program), C.GLint(location), (*C.GLint)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetUniformfv(program glbase.Program, location glbase.Uniform, params []float32) {
	C.gl3_3compat_glGetUniformfv(gl.funcs, C.GLuint(program), C.GLint(location), (*C.GLfloat)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetUniformLocation(program glbase.Program, name []byte) int32 {
	result := C.gl3_3compat_glGetUniformLocation(gl.funcs, C.GLuint(program), (*C.GLchar)(unsafe.Pointer(&name[0])))
	return int32(result)
}
...
func (gl *GL) GetShaderInfoLog(shader glbase.Shader, bufSize int32, length []int32, infoLog []byte) {
	C.gl3_3compat_glGetShaderInfoLog(gl.funcs, C.GLuint(shader), C.GLsizei(bufSize), (*C.GLsizei)(unsafe.Pointer(&length[0])), (*C.GLchar)(unsafe.Pointer(&infoLog[0])))
}
...
func (gl *GL) GetShaderiv(shader glbase.Shader, pname glbase.Enum, params []int32) {
	C.gl3_3compat_glGetShaderiv(gl.funcs, C.GLuint(shader), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetProgramInfoLog(program glbase.Program, bufSize int32, length []int32, infoLog []byte) {
	C.gl3_3compat_glGetProgramInfoLog(gl.funcs, C.GLuint(program), C.GLsizei(bufSize), (*C.GLsizei)(unsafe.Pointer(&length[0])), (*C.GLchar)(unsafe.Pointer(&infoLog[0])))
}
...
func (gl *GL) GetProgramiv(program glbase.Program, pname glbase.Enum, params []int32) {
	C.gl3_3compat_glGetProgramiv(gl.funcs, C.GLuint(program), C.GLenum(pname), (*C.GLint)(unsafe.Pointer(&params[0])))
}
...
func (gl *GL) GetAttribLocation(program glbase.Program, name []byte) int32 {
	result := C.gl3_3compat_glGetAttribLocation(gl.funcs, C.GLuint(program), (*C.GLchar)(unsafe.Pointer(&name[0])))
	return int32(result)
}
...
func (gl *GL) CreateShader(gltype glbase.Enum) glbase.Shader {
	result := C.gl3_3compat_glCreateShader(gl.funcs, C.GLenum(gltype))
...
func (gl *GL) CreateProgram() glbase.Program {
	result := C.gl3_3compat_glCreateProgram(gl.funcs)
...
func (gl *GL) BindAttribLocation(program glbase.Program, index uint32, name []byte) {
	C.gl3_3compat_glBindAttribLocation(gl.funcs, C.GLuint(program), C.GLuint(index), (*C.GLchar)(unsafe.Pointer(&name[0])))
}
...
func (gl *GL) UniformMatrix4x3fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl3_3compat_glUniformMatrix4x3fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix3x4fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl3_3compat_glUniformMatrix3x4fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix4x2fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl3_3compat_glUniformMatrix4x2fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix2x4fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl3_3compat_glUniformMatrix2x4fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix3x2fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl3_3compat_glUniformMatrix3x2fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) UniformMatrix2x3fv(location glbase.Uniform, count int32, transpose glbase.Boolean, value []float32) {
	...
	C.gl3_3compat_glUniformMatrix2x3fv(gl.funcs, C.GLint(location), C.GLsizei(count), C.GLboolean(transpose), (*C.GLfloat)(unsafe.Pointer(&value[0])))
}

// https://www.opengl.org/sdk/docs/man2/xhtml/glIsVertexArray.xml
func (gl *GL) IsVertexArray(array uint32) glbase.Boolean {
	result := C.gl3_3compat_glIsVertexArray(gl.funcs, C.GLuint(array))
	return glbase.Boolean(result)
}
...
func (gl *GL) CheckFramebufferStatus(target glbase.Enum) glbase.Enum {
	result := C.gl3_3compat_glCheckFramebufferStatus(gl.funcs, C.GLenum(target))
	return glbase.Enum(result)
}
...
func (gl *GL) IsFramebuffer(framebuffer uint32) glbase.Boolean {
	result := C.gl3_3compat_glIsFramebuffer(gl.funcs, C.GLuint(framebuffer))
	return glbase.Boolean(result)
}
...
func (gl *GL) IsRenderbuffer(renderbuffer uint32) glbase.Boolean {
	result := C.gl3_3compat_glIsRenderbuffer(gl.funcs, C.GLuint(renderbuffer))
	return glbase.Boolean(result)
}
...
func (gl *GL) GetFragDataLocation(program glbase.Program, name []byte) int32 {
	result := C.gl3_3compat_glGetFragDataLocation(gl.funcs, C.GLuint(program), (*C.GLchar)(unsafe.Pointer(&name[0])))
	return int32(result)
}
...
func (gl *GL) VertexAttribIPointer(index uint32, size int32, gltype glbase.Enum, stride int32, pointer interface{}) {
	...
	C.gl3_3compat_glVertexAttribIPointer(gl.funcs, C.GLuint(index), C.GLint(size), C.GLenum(gltype), C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) IsEnabledi(target glbase.Enum, index uint32) glbase.Boolean {
	result := C.gl3_3compat_glIsEnabledi(gl.funcs, C.GLenum(target), C.GLuint(index))
	return glbase.Boolean(result)
}
...
func (gl *GL) ColorMaski(index uint32, r, g, b, a glbase.Boolean) {
	C.gl3_3compat_glColorMaski(gl.funcs, C.GLuint(index), C.GLboolean(r), C.GLboolean(g), C.GLboolean(b), C.GLboolean(a))
}
...
func (gl *GL) UniformBlockBinding(program glbase.Program, uniformBlockIndex, uniformBlockBinding uint32) {
	C.gl3_3compat_glUniformBlockBinding(gl.funcs, C.GLuint(program), C.GLuint(uniformBlockIndex), C.GLuint(uniformBlockBinding))
}
...
func (gl *GL) GetUniformBlockIndex(program glbase.Program, uniformBlockName []byte) uint32 {
	result := C.gl3_3compat_glGetUniformBlockIndex(gl.funcs, C.GLuint(program), (*C.GLchar)(unsafe.Pointer(&uniformBlockName[0])))
...
func (gl *GL) DrawElementsInstanced(mode glbase.Enum, count int32, gltype glbase.Enum, indices interface{}, instancecount int32) {
	...
	C.gl3_3compat_glDrawElementsInstanced(gl.funcs, C.GLenum(mode), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()), C.GLsizei(instancecount))
}
...
func (gl *GL) TexImage3DMultisample(target glbase.Enum, samples, internalformat, width, height, depth int32, fixedsamplelocations glbase.Boolean) {
	C.gl3_3compat_glTexImage3DMultisample(gl.funcs, C.GLenum(target), C.GLsizei(samples), C.GLint(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLsizei(depth), C.GLboolean(fixedsamplelocations))
}
...
func (gl *GL) TexImage2DMultisample(target glbase.Enum, samples, internalformat, width, height int32, fixedsamplelocations glbase.Boolean) {
	C.gl3_3compat_glTexImage2DMultisample(gl.funcs, C.GLenum(target), C.GLsizei(samples), C.GLint(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLboolean(fixedsamplelocations))
}
...
func (gl *GL) ClientWaitSync(sync glbase.Sync, flags glbase.Bitfield, timeout uint64) glbase.Enum {
	result := C.gl3_3compat_glClientWaitSync(gl.funcs, C.GLsync(sync), C.GLbitfield(flags), C.GLuint64(timeout))
	return glbase.Enum(result)
}
...
func (gl *GL) IsSync(sync glbase.Sync) glbase.Boolean {
	result := C.gl3_3compat_glIsSync(gl.funcs, C.GLsync(sync))
	return glbase.Boolean(result)
}
...
func (gl *GL) FenceSync(condition glbase.Enum, flags glbase.Bitfield) glbase.Sync {
	result := C.gl3_3compat_glFenceSync(gl.funcs, C.GLenum(condition), C.GLbitfield(flags))
...
func (gl *GL) DrawElementsInstancedBaseVertex(mode glbase.Enum, count int32, gltype glbase.Enum, indices interface{}, instancecount, basevertex int32) {
	...
	C.gl3_3compat_glDrawElementsInstancedBaseVertex(gl.funcs, C.GLenum(mode), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()), C.GLsizei(instancecount), C.GLint(basevertex))
}
...
func (gl *GL) DrawRangeElementsBaseVertex(mode glbase.Enum, start, end uint32, count int32, gltype glbase.Enum, indices interface{}, basevertex int32) {
	...
	C.gl3_3compat_glDrawRangeElementsBaseVertex(gl.funcs, C.GLenum(mode), C.GLuint(start), C.GLuint(end), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()), C.GLint(basevertex))
}
...
func (gl *GL) DrawElementsBaseVertex(mode glbase.Enum, count int32, gltype glbase.Enum, indices interface{}, basevertex int32) {
	...
	C.gl3_3compat_glDrawElementsBaseVertex(gl.funcs, C.GLenum(mode), C.GLsizei(count), C.GLenum(gltype), unsafe.Pointer(indices_v.Index(0).Addr().Pointer()), C.GLint(basevertex))
}
...
func (gl *GL) VertexAttribP4uiv(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value []uint32) {
	C.gl3_3compat_glVertexAttribP4uiv(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), (*C.GLuint)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) VertexAttribP4ui(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value uint32) {
	C.gl3_3compat_glVertexAttribP4ui(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), C.GLuint(value))
}
...
func (gl *GL) VertexAttribP3uiv(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value []uint32) {
	C.gl3_3compat_glVertexAttribP3uiv(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), (*C.GLuint)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) VertexAttribP3ui(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value uint32) {
	C.gl3_3compat_glVertexAttribP3ui(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), C.GLuint(value))
}
...
func (gl *GL) VertexAttribP2uiv(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value []uint32) {
	C.gl3_3compat_glVertexAttribP2uiv(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), (*C.GLuint)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) VertexAttribP2ui(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value uint32) {
	C.gl3_3compat_glVertexAttribP2ui(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), C.GLuint(value))
}
...
func (gl *GL) VertexAttribP1uiv(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value []uint32) {
	C.gl3_3compat_glVertexAttribP1uiv(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), (*C.GLuint)(unsafe.Pointer(&value[0])))
}
...
func (gl *GL) VertexAttribP1ui(index uint32, gltype glbase.Enum, normalized glbase.Boolean, value uint32) {
	C.gl3_3compat_glVertexAttribP1ui(gl.funcs, C.GLuint(index), C.GLenum(gltype), C.GLboolean(normalized), C.GLuint(value))
}
...
func (gl *GL) IsSampler(sampler uint32) glbase.Boolean {
	result := C.gl3_3compat_glIsSampler(gl.funcs, C.GLuint(sampler))
	return glbase.Boolean(result)
}
...
func (gl *GL) GetFragDataIndex(program glbase.Program, name []byte) int32 {
	result := C.gl3_3compat_glGetFragDataIndex(gl.funcs, C.GLuint(program), (*C.GLchar)(unsafe.Pointer(&name[0])))
	return int32(result)
}
...
func (gl *GL) IsList(list uint32) glbase.Boolean {
	result := C.gl3_3compat_glIsList(gl.funcs, C.GLuint(list))
	return glbase.Boolean(result)
}
...
func (gl *GL) DrawPixels(width, height int32, format, gltype glbase.Enum, pixels interface{}) {
	...
	C.gl3_3compat_glDrawPixels(gl.funcs, C.GLsizei(width), C.GLsizei(height), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(pixels_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) RenderMode(mode glbase.Enum) int32 {
	result := C.gl3_3compat_glRenderMode(gl.funcs, C.GLenum(mode))
	return int32(result)
}
...
func (gl *GL) EdgeFlag(flag glbase.Boolean) {
	C.gl3_3compat_glEdgeFlag(gl.funcs, C.GLboolean(flag))
}
...
func (gl *GL) GenLists(range_ int32) uint32 {
	result := C.gl3_3compat_glGenLists(gl.funcs, C.GLsizei(range_))
	return uint32(result)
}
...
func (gl *GL) CallLists(n int32, gltype glbase.Enum, lists interface{}) {
	...
	C.gl3_3compat_glCallLists(gl.funcs, C.GLsizei(n), C.GLenum(gltype), unsafe.Pointer(lists_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) AreTexturesResident(n int32, textures []uint32, residences []glbase.Boolean) glbase.Boolean {
	result := C.gl3_3compat_glAreTexturesResident(gl.funcs, C.GLsizei(n), (*C.GLuint)(unsafe.Pointer(&textures[0])), (*C.GLboolean)(unsafe.Pointer(&residences[0])))
	return glbase.Boolean(result)
}
...
func (gl *GL) VertexPointer(size int32, gltype glbase.Enum, stride int32, pointer interface{}) {
	...
	C.gl3_3compat_glVertexPointer(gl.funcs, C.GLint(size), C.GLenum(gltype), C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) TexCoordPointer(size int32, gltype glbase.Enum, stride int32, pointer interface{}) {
	...
	C.gl3_3compat_glTexCoordPointer(gl.funcs, C.GLint(size), C.GLenum(gltype), C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) NormalPointer(gltype glbase.Enum, stride int32, pointer interface{}) {
	...
	C.gl3_3compat_glNormalPointer(gl.funcs, C.GLenum(gltype), C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) InterleavedArrays(format glbase.Enum, stride int32, pointer interface{}) {
	...
	C.gl3_3compat_glInterleavedArrays(gl.funcs, C.GLenum(format), C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) IndexPointer(gltype glbase.Enum, stride int32, pointer interface{}) {
	...
	C.gl3_3compat_glIndexPointer(gl.funcs, C.GLenum(gltype), C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) EdgeFlagPointer(stride int32, pointer interface{}) {
	...
	C.gl3_3compat_glEdgeFlagPointer(gl.funcs, C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) ColorPointer(size int32, gltype glbase.Enum, stride int32, pointer interface{}) {
	...
	C.gl3_3compat_glColorPointer(gl.funcs, C.GLint(size), C.GLenum(gltype), C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) Minmax(target, internalformat glbase.Enum, sink glbase.Boolean) {
	C.gl3_3compat_glMinmax(gl.funcs, C.GLenum(target), C.GLenum(internalformat), C.GLboolean(sink))
}
...
func (gl *GL) Histogram(target glbase.Enum, width int32, internalformat glbase.Enum, sink glbase.Boolean) {
	C.gl3_3compat_glHistogram(gl.funcs, C.GLenum(target), C.GLsizei(width), C.GLenum(internalformat), C.GLboolean(sink))
}
...
func (gl *GL) GetMinmax(target glbase.Enum, reset glbase.Boolean, format, gltype glbase.Enum, values interface{}) {
	...
	C.gl3_3compat_glGetMinmax(gl.funcs, C.GLenum(target), C.GLboolean(reset), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(values_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) GetHistogram(target glbase.Enum, reset glbase.Boolean, format, gltype glbase.Enum, values interface{}) {
	...
	C.gl3_3compat_glGetHistogram(gl.funcs, C.GLenum(target), C.GLboolean(reset), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(values_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) SeparableFilter2D(target, internalformat glbase.Enum, width, height int32, format, gltype glbase.Enum, row, column interface{}) {
	...
	C.gl3_3compat_glSeparableFilter2D(gl.funcs, C.GLenum(target), C.GLenum(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(row_v.Index(0).Addr().Pointer()), unsafe.Pointer(column_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) GetSeparableFilter(target, format, gltype glbase.Enum, row, column, span interface{}) {
	...
	C.gl3_3compat_glGetSeparableFilter(gl.funcs, C.GLenum(target), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(row_v.Index(0).Addr().Pointer()), unsafe.Pointer(column_v.Index(0).Addr().Pointer()), unsafe.Pointer(span_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) GetConvolutionFilter(target, format, gltype glbase.Enum, image interface{}) {
	...
	C.gl3_3compat_glGetConvolutionFilter(gl.funcs, C.GLenum(target), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(image_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) ConvolutionFilter2D(target, internalformat glbase.Enum, width, height int32, format, gltype glbase.Enum, image interface{}) {
	...
	C.gl3_3compat_glConvolutionFilter2D(gl.funcs, C.GLenum(target), C.GLenum(internalformat), C.GLsizei(width), C.GLsizei(height), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(image_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) ConvolutionFilter1D(target, internalformat glbase.Enum, width int32, format, gltype glbase.Enum, image interface{}) {
	...
	C.gl3_3compat_glConvolutionFilter1D(gl.funcs, C.GLenum(target), C.GLenum(internalformat), C.GLsizei(width), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(image_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) ColorSubTable(target glbase.Enum, start, count int32, format, gltype glbase.Enum, data interface{}) {
	...
	C.gl3_3compat_glColorSubTable(gl.funcs, C.GLenum(target), C.GLsizei(start), C.GLsizei(count), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(data_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) GetColorTable(target, format, gltype glbase.Enum, table interface{}) {
	...
	C.gl3_3compat_glGetColorTable(gl.funcs, C.GLenum(target), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(table_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) ColorTable(target, internalformat glbase.Enum, width int32, format, gltype glbase.Enum, table interface{}) {
	...
	C.gl3_3compat_glColorTable(gl.funcs, C.GLenum(target), C.GLenum(internalformat), C.GLsizei(width), C.GLenum(format), C.GLenum(gltype), unsafe.Pointer(table_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) SecondaryColorPointer(size int32, gltype glbase.Enum, stride int32, pointer interface{}) {
	...
	C.gl3_3compat_glSecondaryColorPointer(gl.funcs, C.GLint(size), C.GLenum(gltype), C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}
...
func (gl *GL) FogCoordPointer(gltype glbase.Enum, stride int32, pointer interface{}) {
	...
	C.gl3_3compat_glFogCoordPointer(gl.funcs, C.GLenum(gltype), C.GLsizei(stride), unsafe.Pointer(pointer_v.Index(0).Addr().Pointer()))
}

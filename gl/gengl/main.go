...
var tmplGo = template.Must(template.New("gl.go").Funcs(funcs).Parse(`
...
var tmplFuncsCpp = template.Must(template.New("funcs.cpp").Funcs(funcs).Parse(`
// ** file automatically generated by glgen -- do not edit manually **
...
var tmplFuncsH = template.Must(template.New("funcs.h").Funcs(funcs).Parse(`
// ** file automatically generated by glgen -- do not edit manually **

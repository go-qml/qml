...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PlainObject_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PlainObject_t qt_meta_stringdata_PlainObject = {
    {
QT_MOC_LITERAL(0, 0, 11), // "PlainObject"
QT_MOC_LITERAL(1, 12, 9), // "plainType"
QT_MOC_LITERAL(2, 22, 9) // "plainAddr"

    },
    "PlainObject\0plainType\0plainAddr"
};
#undef QT_MOC_LITERAL
...
void PlainObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        PlainObject *_t = static_cast<PlainObject *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
const QMetaObject PlainObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PlainObject.data,
      qt_meta_data_PlainObject,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_PlainObject.stringdata0))
